...
function Home() {
  ...
  const { user, userDB, setUserProfile, setAlbunImage, qr, setQr, setDataUrl, setUserSuccess, success, setUserData, pageOne, pageTwo, pageThree, handlerPageView, numeration, image, dataUrl, userImage } = useUser()
    ...
    <Layout >
      ...
      <div className={style.container}>
        ...
        {userDB && userDB.users && userDB.users[user.uid] && userDB.users[user.uid].uid
          ...
          ? <InvoicePDF style={style.pluss} dbUrl={dataUrl} img={image} />
